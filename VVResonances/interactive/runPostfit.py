...
colors = [ROOT.kGray+2,ROOT.kRed,ROOT.kBlue,ROOT.kTeal+4,210,210,ROOT.kMagenta,ROOT.kMagenta,ROOT.kOrange,ROOT.kOrange,ROOT.kViolet,ROOT.kViolet]
...
def MakePlots(histos,hdata,hsig,axis,nBins,normsig = 1.,errors=None):
    ...
    leg.AddEntry(histos[3],"t#bar{t}","l")
...
def doZprojection(pdfs,data,norm_nonres,norm_Wres,pdf_sig,norm_sig,norm_Zres,norm_TTJets): 
    ...
    for i in range(0,len(pdfs)):
	   ...
	   elif "TTJets" in str(pdfs[i].GetName()): h[i].Fill(zv,lv[i][zv]*norm_TTJets[0])
	   else: h[i].Fill(zv,lv[i][zv]*(norm_Wres[0]+norm_Zres[0]+norm_TTJets[0]+norm_nonres[0]))
    ...
    htot_TTJets = ROOT.TH1F("htot_TTJets","htot_TTJets",len(zBinslowedge)-1,zBinslowedge)
    htot_TTJets.Add(h[3])
    ...
    if doFit:
        errors = draw_error_band(htot,norm_nonres[0]+norm_Wres[0]+norm_Zres[0]+norm_TTJets[0],math.sqrt(norm_nonres[1]*norm_nonres[1]+norm_Wres[1]*norm_Wres[1]+norm_Zres[1]*norm_Zres[1]+norm_TTJets[1]*norm_TTJets[1]),pdfs[-1],zBinslowedge,'z')
...
def doXprojection(pdfs,data1,norm1_nonres,norm1_Wres,pdf1_sig,norm1_sig,norm1_Zres,norm1_TTJets):
    ...
    for i in range(0,len(pdfs)):
	   ...
	   elif "TTJets" in str(pdfs[i].GetName()): h[i].Fill(xv,lv[i][xv]*norm1_TTJets[0])
	   else: h[i].Fill(xv,lv[i][xv]*(norm1_Wres[0]+norm1_Zres[0]+norm1_TTJets[0]+norm1_nonres[0]))
    ...
    htot_TTJets = ROOT.TH1F("htot_TTJets","htot_TTJets",len(xBinslowedge)-1,xBinslowedge)
    htot_TTJets.Add(h[3])
    ...
    dh.SetBinErrorOption(ROOT.TH1.kPoisson)
    if doFit:
        errors = draw_error_band(htot,norm1_nonres[0]+norm1_Wres[0]+norm1_Zres[0]+norm1_TTJets[0],math.sqrt(norm1_nonres[1]*norm1_nonres[1]+norm1_Wres[1]*norm1_Wres[1]+norm1_Zres[1]*norm1_Zres[1]+norm1_TTJets[1]*norm1_TTJets[1]),pdfs[-1],xBinslowedge,'x')
...
def doYprojection(pdfs,data1,norm1_nonres,norm1_Wres,pdf1_sig,norm1_sig,norm1_Zres,norm1_TTJets):
    data1 = ROOT.RooDataHist("data1","data1",args_ws,data1)
    ...
    for i in range(0,len(pdfs)):
	   ...
	   elif "TTJets" in str(pdfs[i].GetName()): h[i].Fill(yv,lv[i][yv]*norm1_TTJets[0])
	   
	   else: h[i].Fill(yv,lv[i][yv]*(norm1_Wres[0]+norm1_Zres[0]+norm1_TTJets[0]+norm1_nonres[0]))
    ...
    htot_TTJets = ROOT.TH1F("htot_TTJets","htot_TTJets",len(yBinslowedge)-1,yBinslowedge)
    htot_TTJets.Add(h[3])
    ...
    dh.SetBinErrorOption(ROOT.TH1.kPoisson)
    if doFit:
        errors = draw_error_band(htot,norm1_nonres[0]+norm1_Wres[0]+norm1_Zres[0]+norm1_TTJets[0],math.sqrt(norm1_nonres[1]*norm1_nonres[1]+norm1_Wres[1]*norm1_Wres[1]+norm1_Zres[1]*norm1_Zres[1]+norm1_TTJets[1]*norm1_TTJets[1]),pdfs[-1],yBinslowedge,'y')
...
#     purity = options.name.split('_')[3]+"_"+ options.name.split('_')[4]
     ...
     print "Expected number of tt events:",(args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+period+"_proc_TTJets"].getVal(),"("+period+")"
     if options.fitSignal:
     ...
     pdf1_TTJets_shape_postfit  = args["shapeBkg_TTJets_JJ_"+purity+"_13TeV_2016"]
     pdf1_TTJets_shape_postfit.Print()
     ...
     print "add top"
     allpdfsz.append(pdf1_TTJets_shape_postfit)
     ...
     allpdfsx.append(pdf1_TTJets_shape_postfit)
     ...
     allpdfsy.append(pdf1_TTJets_shape_postfit)
     ...
     print
     (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+period+"_proc_TTJets"].dump()
     norm1_TTJets[0] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+period+"_proc_TTJets"].getVal()
     if doFit:
       norm1_TTJets[1] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+period+"_proc_TTJets"].getPropagatedError(fitresult)
     ...
     if doFit:                
        ...
        print "tt normalization after fit: ",norm1_TTJets[0],"+/-",norm1_TTJets[1],"("+period+")"
     ...
     if options.projection =="z": doZprojection(allpdfsz,data1,norm1_nonres,norm1_Wres,pdf1_signal_postfit,norm1_sig,norm1_Zres,norm1_TTJets)
         
     #make projections onto MJ1 axis
     if options.projection =="x": doXprojection(allpdfsx,data1,norm1_nonres,norm1_Wres,pdf1_signal_postfit,norm1_sig,norm1_Zres,norm1_TTJets)
                  
     #make projections onto MJ2 axis
     if options.projection =="y": doYprojection(allpdfsy,data1,norm1_nonres,norm1_Wres,pdf1_signal_postfit,norm1_sig,norm1_Zres,norm1_TTJets)
         
     if options.projection =="xyz":
      doZprojection(allpdfsz,data1,norm1_nonres,norm1_Wres,pdf1_signal_postfit,norm1_sig,norm1_Zres,norm1_TTJets)
      doXprojection(allpdfsx,data1,norm1_nonres,norm1_Wres,pdf1_signal_postfit,norm1_sig,norm1_Zres,norm1_TTJets)
      doYprojection(allpdfsy,data1,norm1_nonres,norm1_Wres,pdf1_signal_postfit,norm1_sig,norm1_Zres,norm1_TTJets)
