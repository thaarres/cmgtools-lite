...
# python makeInputs_deepWZHDDT.py -p 2016 --run "detector"
# python makeInputs_deepWZHDDT.py -p 2016 --run "signorm" --signal "ZprimeWW" --batch False 
# python makeInputs_deepWZHDDT.py -p 2016 --run "vjets" --batch False                                                                                                                                      
# python makeInputs_deepWZHDDT.py -p 2016 --run "qcdtemplates"
# python makeInputs_deepWZHDDT.py -p 2016 --run "qcdkernel"
# python makeInputs_deepWZHDDT.py -p 2016 --run "qcdnorm"
# python makeInputs_deepWZHDDT.py -p 2016 --run "data"
# python makeInputs_deepWZHDDT.py -p 2016 --run "pseudoNOVJETS"
# python makeInputs_deepWZHDDT.py -p 2016 --run "pseudoVJETS"                                                                                                                                                                                                                   
...
catVtag['LP1'] = 'jj_l1_MassDecorrelatedDeepBoosted_WvsQCD<0.8&&jj_l1_MassDecorrelatedDeepBoosted_WvsQCD>0.4'
catVtag['LP2'] = 'jj_l2_MassDecorrelatedDeepBoosted_WvsQCD<0.8&&jj_l2_MassDecorrelatedDeepBoosted_WvsQCD>0.4'
catVtag['NP1'] = 'jj_l1_MassDecorrelatedDeepBoosted_WvsQCD<0.4'
catVtag['NP2'] = 'jj_l2_MassDecorrelatedDeepBoosted_WvsQCD<0.4'
'''
...
catHtag['LP1'] = '(jj_l1_MassDecorrelatedDeepBoosted_ZHbbvsQCD>0.4&&jj_l1_MassDecorrelatedDeepBoosted_ZHbbvsQCD<0.8)'
catHtag['LP2'] = '(jj_l2_MassDecorrelatedDeepBoosted_ZHbbvsQCD>0.4&&jj_l2_MassDecorrelatedDeepBoosted_ZHbbvsQCD<0.8)'
catHtag['NP1'] = '(jj_l1_MassDecorrelatedDeepBoosted_ZHbbvsQCD<0.4)'
catHtag['NP2'] = '(jj_l2_MassDecorrelatedDeepBoosted_ZHbbvsQCD<0.4)'
'''
'''
...
if sorting == 'random':
 ...
 '''
 # scheme 1: VH_HPHP -> VH_LPHP -> VH_HPLP -> VV_HPHP & VV_HPLP
 #at least one H tag HP (+ one V/H tag HP) 
 catsAll['VH_HPHP'] = '('+'&&'.join([catVtag['HP1'],catHtag['HP2']])+')'
 catsAll['HV_HPHP'] = '('+'&&'.join([catHtag['HP1'],catVtag['HP2']])+')'
 catsAll['HH_HPHP'] = '('+'&&'.join([catHtag['HP1'],catHtag['HP2']])+')'
 ...
 catsAll['HH_HPLP'] = '('+'&&'.join([catHtag['HP1'],catHtag['LP2']])+')'
 catsAll['HH_LPHP'] = '('+'&&'.join([catHtag['LP1'],catHtag['HP2']])+')'
 cuts['VH_LPHP'] = '('+'('+'!'+cuts['VH_HPHP']+')&&('+'||'.join([catsAll['VH_LPHP'],catsAll['HV_HPLP'],catsAll['HH_HPLP'],catsAll['HH_LPHP']])+')'+')'
 
 #at least one V-tag HP (+ one H-tag LP)  
 catsAll['VH_HPLP'] = '('+'&&'.join([catVtag['HP1'],catHtag['LP2']])+')'
 catsAll['HV_LPHP'] = '('+'&&'.join([catHtag['LP1'],catVtag['HP2']])+')'
 cuts['VH_HPLP'] = '('+'('+'!'+cuts['VH_LPHP']+'&&!'+cuts['VH_HPHP']+')&&('+'||'.join([catsAll['VH_HPLP'],catsAll['HV_LPHP']])+')'+')'
...
# cuts['VH_all'] =  '('+  '||'.join([cuts['VH_HPHP'],cuts['VH_LPHP'],cuts['VH_HPLP'],cuts['VH_LPLP']]) + ')'
 ...
 cuts['VV_HPLP'] = '(' + '!' + cuts['VH_all'] + '&&' + '(' + '('+  '&&'.join([catVtag['HP1'],catVtag['LP2']]) + ')' + '||' + '(' + '&&'.join([catVtag['HP2'],catVtag['LP1']]) + ')' + ')' + ')'
 cuts['VV_all'] =  '('+  '||'.join([cuts['VV_HPHP'],cuts['VV_HPLP']]) + ')'
 #validation regions 
 cuts['VH_LPLP'] = '('+'!'+cuts['VH_all']+'&&!'+cuts['VV_all']+')&&('+'('+ '&&'.join([catVtag['LP1'],catHtag['LP2']]) + ')'+ '||' +'(' + '&&'.join([catVtag['LP2'],catHtag['LP1']]) + ')' + '||' + '(' + '&&'.join([catVtag['LP2'],catHtag['LP1']]) + ')' +'||' + '(' + '&&'.join([catHtag['LP2'],catHtag['LP1']]) + ')' + ')'
 cuts['VV_LPLP'] = '('+'!'+cuts['VH_all']+'&&!'+cuts['VV_all']+'&&!'+cuts['VH_LPLP']+')&&(' + '&&'.join([catVtag['LP1'],catVtag['LP2']]) + ')'
 '''
...
#categories=['VV_HPLP'] #,'VH_LPHP','VV_HPHP','VV_HPLP'] 
#categories=['VH_HPHP','VH_LPHP','VV_HPHP','VV_HPLP'] 
#categories=['VV_LPLP'] #,'VV_HPLP']
#categories=['none'] #,'VV_HPLP']
