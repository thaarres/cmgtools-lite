...
def calculateWeight(e,category,uncertainty_var, uncertainty_num,variation):
    ...
    if e.jj_l1_mergedVTruth==1: 
        jet1truth = 'V'
    if e.jj_l1_mergedHTruth==1: 
        jet1truth = 'H'
    jet2truth = ''
    if e.jj_l2_mergedVTruth==1: jet2truth = 'V'
    if e.jj_l2_mergedHTruth==1: jet2truth = 'H'
