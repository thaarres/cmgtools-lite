...
// root .x 'Projections3DHisto.C ("JJ_nonRes_HPHP.root", "nonRes", "JJ_nonRes_2D_HPHP.root","histo","2Dkernels")' --> HPHP
// root .x 'Projections3DHisto.C ("JJ_nonRes_HPLP.root", "nonRes", "JJ_nonRes_2D_HPLP.root","histo","2Dkernels")' --> HPLP
// 
