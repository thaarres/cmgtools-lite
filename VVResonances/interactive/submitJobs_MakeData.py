...
options = ' -d 0'
options+= ' -c "((HLT_JJ)*(run>500) + (run<500))*(njj>0&&Flag_goodVertices&&Flag_CSCTightHaloFilter&&Flag_HBHENoiseFilter&&Flag_HBHENoiseIsoFilter&&Flag_eeBadScFilter&&jj_LV_mass>700&&abs(jj_l1_eta-jj_l2_eta)<1.3&&jj_l1_softDrop_mass>0.&&jj_l2_softDrop_mass>0.)*(jj_l1_tau2/jj_l1_tau1<0.35&&jj_l2_tau2/jj_l2_tau1<0.35)*1*(jj_LV_mass>1000.0&&jj_LV_mass<7000.0&&jj_l1_softDrop_mass>55.0&&jj_l1_softDrop_mass<610.0&&jj_l2_softDrop_mass>55.0&&jj_l2_softDrop_mass<610.0)"'
options+= ' -v "jj_l1_softDrop_mass,jj_l2_softDrop_mass,jj_LV_mass" -b "277,277,160" -m "55.0,55.0,1000.0" -M "610.0,610.0,7000.0" -f 1.0 -n "nonRes"'
