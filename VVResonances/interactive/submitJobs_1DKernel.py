...
options+= ' -v "jj_gen_partialMass" -b 160  -x 1000.0 -X 7000.0'
options+= ' -r /afs/cern.ch/user/j/jngadiub/workdir/VVAnalysisWith2DFit/CMGToolsForStat74X/CMSSW_7_4_7/src/CMGTools/VVResonances/interactive/JJ_nonRes_detectorResponse_HPLP.root'
